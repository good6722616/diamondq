...
function Services() {
  return (
    <div id="service-section" className="swiper-slide reverse-color">
              ...
              <div className="col-lg-7">
                <a href="#" className="service-card">
                  ...
                  <div className="tags">
                    ...
                    <span className="tag"> New Construction & ADU </span>

                    <span className="tag"> Luxury Residential Design </span>
                    <span className="tag"> Constructions & Renovation </span>
                  </div>
                </a>
              </div>
